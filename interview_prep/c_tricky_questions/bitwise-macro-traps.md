...
> For macro fundamentals (parenthesization, `do/while(0)`, stringification, token pasting), see [preprocessor.md](../../c_core/macros_inline/preprocessor.md). For bit manipulation basics (set/clear/toggle, power-of-2, popcount), see [bitwise-operations.md](../../c_core/bit_manipulation/bitwise-operations.md). This file focuses on **tricky interview gotchas** that go beyond the concept explanations.
